...
// will respond to.
    ...
    protected function assembleManifest($dependencySet, $dependencySetIndex, $dependencySets,
                                        ...
                                        $rollingPathsMarkedNoCompile, ManifestContentsGenerator $generator)
    {
        ...
        if (count($dependencySet->stylesheets) > 0 || count($dependencySet->packages) > 0 || $totalDependencies > 1) {
